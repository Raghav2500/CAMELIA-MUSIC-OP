...
OWNER_USERNAME = getenv("OWNER_USERNAME","II_SM4UG_II")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002012471389))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6468964089))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/camelia_supportt")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/camelia_x_chat")
